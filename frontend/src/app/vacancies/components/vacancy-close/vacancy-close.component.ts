...
@Component({
    selector: 'vacancy-close',
    templateUrl: 'vacancy-close.component.html',
    styleUrls: [
        'vacancy-close.component.scss'
    ],
})

export class VacancyCloseComponent implements OnInit, OnDestroy {
